...
export { cacher, compose, constant, defaultPredicate, delegatesFrom, delegatesTo, generatorProto, identity, ifElse, invoke, isArray, isString, javaScriptTypes, noop, not, sortDirection, strictEquals, type, unfoldWith, when, wrap };